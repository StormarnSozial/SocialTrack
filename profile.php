...
<script type="text/javascript">
  ...
  <table class="profile" style="float: none; margin: 30px auto; font-size: larger; align-items: center;">
    ...
    <tr>
        <td style="padding-left: 10px; padding-right: 10px; border: 2px solid black;"></td>
        <td style="padding-left: 10px; padding-right: 10px; border: 2px solid black; font-weight: bold;">Nicht Signiert:</td>
        <td style="padding-left: 10px; padding-right: 10px; border: 2px solid black; font-weight: bold;"><?php
            $team = "null";
            if (!empty($_POST["team"])) {
                $team = $_POST["team"];
    ...
    <tr>
        <td style="padding-left: 10px; padding-right: 10px; border: 2px solid black;"></td>
        <td style="padding-left: 10px; padding-right: 10px; border: 2px solid black; font-weight: bold;">Alle:</td>
        <td style="padding-left: 10px; padding-right: 10px; border: 2px solid black; font-weight: bold;"><?php
            $team = "null";
            if (!empty($_POST["team"])) {
                $team = $_POST["team"];
